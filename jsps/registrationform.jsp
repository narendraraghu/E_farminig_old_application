...
<A HREF="./jsps/beforeregistration.jsp"><FONT COLOR="white" SIZE=2 FACE="arial,helvetica"><B>Go For Lesson</B></FONT></A><BR><br>
...
<tr>
    ...
    <td width="276">
      <input type="text" name="role" value="FARMER" size="20"/>
    </td>
</tr>
<tr>
