 ...
 <form action=""  name="states">
   ...
   <caption></caption>
     ...
     <tr>
        <td>Select State</td>
        <td align="center"> 
				<select select name="dname" id="select" onchange="javascript:if(document.states.dname.value==''){alert('Select Any Department');}  {location.href='./ViewDistrictAction?statename='+document.states.dname.value;}">
				<c:choose>
