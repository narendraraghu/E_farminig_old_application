	...
	<body onload="javascript:disableBackButton()">
		...
		<br />
			...
			<table align="center" border="1" bgcolor="#A1B2C3" width="60%"
				...
				<tr><th bgcolor="#cp987">Course Name</th><th bgcolor="#cp987">Scheduleddate</th><th bgcolor="#cp987">Time</th><th bgcolor="#cp987">Place</th><th bgcolor="#cp987">Facultyname</th></tr><br><br>
