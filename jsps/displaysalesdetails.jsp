		...
		<br />
		   <%ResourceBundle rb= (ResourceBundle)session.getAttribute("resource");%>
			<table align="center" border="1" bgcolor="#A1B2C3" width="70%" cellpadding="10">
				<caption>
					<h3>
						<%=rb.getString("farmerscropsalesdetails")%>
					</h3>
				</caption>
				
				<tr><th bgcolor="#acd9283"> <%=rb.getString("crop")%> <%=rb.getString("name")%> </th> <th bgcolor="#acd9283"> <%=rb.getString("order")%> <%=rb.getString("quantity")%> </th><th bgcolor="#acd9283"> <%=rb.getString("total")%> <%=rb.getString("price")%></th><th bgcolor="#acd9283"> <%=rb.getString("paiddate")%> </th><th bgcolor="#acd9283"><%=rb.getString("paymentmode")%> </th></tr>
				<tr bgcolor="#adede">
				</tr>
