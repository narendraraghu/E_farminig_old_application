 ...
 <form action=""  name="budget">
   ...
   <caption></caption>
     ...
     <tr><td>District Name</td><td> 
				<select name="dname1" id="select" onchange="javascript:if(document.budget.dname1.value==''){alert('Select Any Department');}  {var statename=document.getElementById('dname').value;var dist=document.getElementById('dname1').value;location.href='./ViewCropsforWholesalerAction?distname='+dist+'&statename='+statename}">
				<c:choose>
